...
SRC_INPUT_FILES = $(SRC_DIR)/generic_list.c $(SRC_DIR)/label_list.c $(SRC_DIR)/element_list.c $(SRC_DIR)/string_operations.c $(SRC_DIR)/spice_format.c $(SRC_DIR)/mna.c $(SRC_DIR)/build_matrices.c $(SRC_DIR)/main.c
